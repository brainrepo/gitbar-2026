...
- **Gli agenti sono for loop glorificati**: un agente � semplicemente un ciclo che inserisce tool nella context window come JSON schema e fa tool calls sputando JSON strutturato invece di testo
...
- Lo Spec Driven Development ci ha riportato a una verit� che conoscevamo da sempre: bisogna accendere il cervello e scrivere le specifiche PRIMA del codice - abbiamo solo dovuto distruggere mezza foresta amazzonica per ricordarcelo
